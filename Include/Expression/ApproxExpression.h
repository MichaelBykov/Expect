// ===--- ApproxExpression.h ------------------------------------- C++ ---=== //
//                                                                            //
// © 2022, Michael Bykov                                                      //
//                                                                            //
// ===--------------------------------------------------------------------=== //
//                                                                            //
// The interface for approximate assertion expressions.                       //
//                                                                            //
// ===--------------------------------------------------------------------=== //
...
namespace ApproxExpressions {



/// Expect that two values are approximately equal.
template<typename T>
struct Equal : Expressions::Expression {
  ...
  std::string failMessage() {
    return toString(lhs).append(" is not approximately equal to ")
...
/// Expect that two values are approximately not equal.
template<typename T>
struct NotEqual : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return toString(lhs).append(" is approximately equal to ")
      .append(toString(rhs)).append(".");
  }
...
struct InclusiveRange : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return toString(value).append(" is not approximately within the range of ")
...
/// Expect that one value is approximately less than another value.
template<typename T>
struct Less : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return toString(lhs).append(" is not approximately less than ")
      .append(toString(rhs)).append(".");
  }
  ...
  /// Expect that the loaded value is approximately within an exclusive range of
  /// values.
  /// \param[in] other
  ...
  /// Expect that the loaded value is approximately within an exclusive,
...
/// Expect that one value is approximately less than or equal to another value.
template<typename T>
struct LessEqual : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return toString(lhs).append(" is not approximately less than or equal to ")
      .append(toString(rhs)).append(".");
  }
  ...
  /// Expect that the loaded value is approximately within an inclusive,
  ...
  /// Expect that the loaded value is approximately within an inclusive range of
  /// values.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
...
/// Expect that one value is approximately greater than another value.
template<typename T>
struct Greater : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return toString(lhs).append(" is not approximately greater than ")
      .append(toString(rhs)).append(".");
  }
...
/// Expect that one value is approximately greater than or equal to another
/// value.
template<typename T>
struct GreaterEqual : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return toString(lhs).append(
      " is not approximately greater than or equal to "
    ).append(toString(rhs)).append(".");
  }
...
struct Value : Expressions::Expression {
  ...
  /// The message to report if the evaluation failed.
  std::string failMessage() {
    return "Result is approximately equal to zero.";
  }
  ...
  /// Expect that the loaded value is approximately equal to another value.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
  ...
  /// Expect that the loaded value is approximately not equal to another value.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
  ...
  /// Expect that the loaded value is approximately less than another value.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
  ...
  /// Expect that the loaded value is approximately less than or equal to
  /// another value.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
  ...
  /// Expect that the loaded value is approximately greater than another value.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
  ///   A comparison expectation.
  ...
  /// Expect that the loaded value is approximately greater than or equal to
  /// another value.
  /// \param[in] other
  ///   The value to compare the loaded value to.
  /// \returns
